...
/// Step 2b (Phone-first): Email Verification Screen after Phone Verification
/// User enters 6-digit verification code sent to their email
class EmailVerificationAfterPhoneScreen extends StatefulWidget {
  static const routeName = '/email-verification-after-phone';

  const EmailVerificationAfterPhoneScreen({super.key});

  @override
  EmailVerificationAfterPhoneScreenState createState() =>
      EmailVerificationAfterPhoneScreenState();
}

class EmailVerificationAfterPhoneScreenState
    extends State<EmailVerificationAfterPhoneScreen> {
      ...
      body: BlocListener<AuthenticationBloc, AuthenticationState>(
        ...
        listener: (context, state) {
          if (state is EmailVerified) {
            ...
            // Both email and phone verified, navigate to address entry
